...
<div class="row">
    <div class="col-md-3">
        ...
        <div class="box-body">
            ...
            <hr>
            <strong><i class="fa fa-calendar margin-r-5"></i>Tanggal Gabung</strong>
            <p class="text-muted"><?= date('d M Y',strtotime($profile['tgl_gabung'])); ?></p>
    ...
    <div class="col-md-9">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#informasi" data-toggle="tab">Informasi</a></li>
        ...
        <div class="tab-content">
            <div class="active tab-pane" id="informasi">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label for="inputName" class="col-sm-2 control-label"><?= $profile['nama']; ?></label>
                    </div>
                </div>
            </div>
