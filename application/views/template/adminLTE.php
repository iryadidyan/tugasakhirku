...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>asset/AdminLTE/bower_components/morris.js/morris.css">
  <link rel="stylesheet" href="<?= base_url(); ?>asset/AdminLTE/bower_components/jvectormap/jquery-jvectormap.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admins</b>LTE</span>
    </a>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<?= base_url(); ?>asset/AdminLTE/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?= base_url(); ?>asset/AdminLTE/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?= base_url(); ?>asset/AdminLTE/dist/img/user2-160x160.jpg" alt="user image" class="offline">
...
<script src="<?= base_url(); ?>asset/AdminLTE/bower_components/raphael/raphael.min.js"></script>
<script src="<?= base_url(); ?>asset/AdminLTE/bower_components/morris.js/morris.min.js"></script>
<script src="<?= base_url(); ?>asset/AdminLTE/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<script src="<?= base_url(); ?>asset/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?= base_url(); ?>asset/AdminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
